...
namespace AniDb.Api
{
    public interface IAniDbHttpApi: IDisposable
    {
        ...
        Task<Response<Anime>> GetAnime(int animeId, CancellationToken cancellationToken = default);
        ...
        Task<Response<RandomRecommendations>> GetRandomRecommendationAnime(CancellationToken cancellationToken = default);
        ...
        Task<Response<RandomSimilar>> GetRandomSimilarAnime(CancellationToken cancellationToken = default);
        ...
        Task<Response<HotAnimeCollection>> GetHotAnime(CancellationToken cancellationToken = default);
        ...
        Task<Response<MainPage>> GetMainPageData(CancellationToken cancellationToken = default);
        ...
        Task<Response<MyListSummary>> GetUserMyListSummmary(string username, string password, CancellationToken cancellationToken = default);
        ...
        Task<Response<HintCollection>> GetUserHints(string username, string password, CancellationToken cancellationToken = default);
